...
This page is a **production-focused** cheat sheet: high-leverage configs, what they *really* control, and what to validate in the Spark UI (e.g. during tuning or **design review**).
