...
- [patterns](patterns/README.md): reusable Spark and lakehouse design patterns.
- [tuning](tuning/README.md): focused performance tuning references.
- [checklists](checklists/README.md): repeatable operating checklists.
