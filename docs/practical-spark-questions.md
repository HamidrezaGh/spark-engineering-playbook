# Practical Spark self-check questions

Use this as a **depth checklist** when you want to verify you understand a topic in a
**production-oriented** way. The point is not short memorized answers: each bullet should
expand into **internal behavior**, **tradeoffs**, **Spark UI / EXPLAIN evidence**, and a credible
**failure or regression** story.

**Where to go deeper:** the [concept map](concept-map.md) links questions to chapters and
runnable examples.

| # | Primary chapter | Troubleshooting (if any) |
| --- | --- | --- |
| 1 | [Execution model](book/01-execution-model.md) | [slow job](troubleshooting/slow-job.md) |
| 2 | [Shuffle](book/02-shuffle-and-performance.md) | [shuffle-heavy](troubleshooting/shuffle-heavy-job.md) |
| 3 | [Partitioning](book/03-partitioning.md) | [small files](troubleshooting/small-files.md) |
| 4 | [Joins](book/04-joins.md) | [join](troubleshooting/join-performance.md) |
| 5 | [Skew](book/05-data-skew.md) | [skew](troubleshooting/skew-and-stragglers.md) |
| 6 | [AQE](book/06-adaptive-query-execution.md) | — |
| 7 | [Memory](book/07-memory-management.md) | [OOM / spill](troubleshooting/memory-spill-oom.md) |
| 8 | [File formats](book/08-file-formats.md) | — |
| 9 | [Catalyst / SQL](book/09-spark-sql-and-catalyst.md) | [Physical plans](observability/physical-plans.md) |
| 10 | [Caching](book/10-caching-and-persistence.md) | — |
| 11 | [EMR / YARN](book/11-spark-on-yarn-and-emr.md) | [emr-yarn](troubleshooting/emr-yarn-failures.md) |
| 12 | [Production debugging](book/12-production-debugging.md) | [UI guide](observability/spark-ui-guide.md) |
| 13 | [Iceberg](book/13-iceberg-and-spark.md) | [iceberg merge](troubleshooting/iceberg-merge-issues.md) |
| 14 | [Streaming](book/14-structured-streaming.md) | [streaming lag](troubleshooting/streaming-lag.md) |
| 15 | [Platform patterns](book/15-platform-patterns.md) | — |
| 16+ | (see headings below) | — |
...
## 15. Platform patterns and multi-team operations
...
## Answer standard (for when you use this as study material)

A complete answer to any section usually includes: **direct** answer, **internal** behavior,
**production** tradeoff, **UI / EXPLAIN** or **log** signal, a **tuning** option you would reject
and why, and a small **concrete** scenario (yours, anonymized, or from the [case
studies](case-studies/README.md)).
